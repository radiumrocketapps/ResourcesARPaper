cordova.define("com.wikitude.phonegap.wikitudeplugin.WikitudePlugin", function (
	require,
	exports,
	module
) {
	 ...
	 */
	WikitudePlugin.prototype.isDeviceSupported = function (
		successCallback,
		errorCallback,
		requiredFeatures
	) {
	 ...
	 */
	WikitudePlugin.prototype.requestAccess = function (
		successCallback,
		errorCallback,
		requiredFeatures
	) {
	 ...
	 */
	WikitudePlugin.prototype.setOnUrlInvokeCallback = function (
		onUrlInvokeCallback
	) {
		cordova.exec(
			onUrlInvokeCallback,
	 ...
	 */
	WikitudePlugin.prototype.setJSONObjectReceivedCallback = function (
	 ...
	 */
	WikitudePlugin.prototype.setLocation = function (
		latitude,
		longitude,
		altitude,
		accuracy
	 ...
	 */
	WikitudePlugin.prototype.captureScreen = function (
		successCallback,
		errorCallback,
		includeWebView,
		imagePathInBundleOrNullForPhotoLibrary
	) {
		cordova.exec(
			successCallback,
			errorCallback,
			"WikitudePlugin",
			"captureScreen",
			[includeWebView, imagePathInBundleOrNullForPhotoLibrary]
		);
	};
	 ...
	 */
	WikitudePlugin.prototype.setDeviceSensorsNeedCalibrationHandler = function (
	 ...
	 */
	WikitudePlugin.prototype.setDeviceSensorsFinishedCalibrationHandler = function (
		finishedCalibrationHandler
	) {
		cordova.exec(
			finishedCalibrationHandler,
			this.onWikitudeError(),
	 ...
	 */
	WikitudePlugin.prototype.setBackButtonCallback = function (
