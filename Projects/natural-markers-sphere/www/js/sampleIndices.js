...
var samples = [
	...
	[
		...
		{
			path:
				"www/world/03_MultipleTargets_3_TransformationBetweenTargets/index.html",
			requiredFeatures: ["image_tracking"],
			startupConfiguration: {
				camera_position: "back"
			}
	...
	[
		...
		{
			path:
				"www/world/04_CloudRecognition_2_ContinuousImageRecognition/index.html",
			requiredFeatures: ["image_tracking"],
			startupConfiguration: {
				camera_position: "back"
			}
		...
		{
			path:
				"www/world/04_CloudRecognition_3_UsingMetainformationInTheResponse/index.html",
			requiredFeatures: ["image_tracking"],
			startupConfiguration: {
				camera_position: "back"
			}
	...
	[
		...
		{
			path: "www/world/05_InstantTracking_5_SaveInstantTarget/index.html",
			requiredFeatures: ["instant_tracking"],
			startupConfiguration: {
				camera_position: "back"
			}
		...
		{
			path: "www/world/05_InstantTracking_6_LoadInstantTarget/index.html",
			requiredFeatures: ["instant_tracking"],
			startupConfiguration: {
				camera_position: "back"
			}
	...
	[
		...
		{
			path:
				"www/world/06_ObjectTracking_2_2dImageAndSoundAugmentations/index.html",
			requiredFeatures: ["object_tracking"],
			startupConfiguration: {
				camera_position: "back"
			}
		...
		{
			path: "www/world/06_ObjectTracking_4_ExtendedObjectTracking/index.html",
			requiredFeatures: ["object_tracking"],
			startupConfiguration: {
				camera_position: "back"
			}
	...
	[
		...
		},
		{
			...
			requiredFeatures: ["geo", "photo_library_screenshot_import"],
			startupConfiguration: {
				camera_position: "back"
			}
		}
